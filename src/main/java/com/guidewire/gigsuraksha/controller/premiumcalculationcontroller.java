...
@RestController
@RequestMapping("/api/premium/legacy")
public class premiumcalculationcontroller {
    ...
    public String computePremium(@PathVariable UUID partnerId,
        ...
        service.computePremium(partnerId, LocalDate.parse(week),
                expectedWeeklyIncome, riskFactorR, variabilityV, coverageMultiplierC, crf);
